...
class OrdersMapper extends BaseMapper
{
    ...
    public function manuscripts($where) {
        return Db::table("orders")->alias("o")
            ...
            ->where($where)
            ->field("o.id, o.engineer_id, sum(o.manuscript_fee) as manuscript_fee, sum(o.settlemented) as settlemented, sum(o.deduction) as deduction, o.delivery_time, e.qq_nickname, e.contact_qq, e.collection_code")
